...
class AccountDisbursementJournalSummary(models.AbstractModel):
    _name = 'account.disbursement.journal.summary'
    _description = 'Cash Disbursement Journal Summary'
    _inherit = 'account.journal.summary'

    #     filter_journals = [{'id': 'cash', 'name': _('Cash'), 'type': 'cash', 'selected': True}, {'id': 'bank', 'name': _('Bank'), 'type': 'bank', 'selected': True}]
    ...
    @api.model
    def get_title(self):
        return _('Cash Disbursement Journal Report')

    def _get_report_name(self):
        return _("Cash Disbursement Journal Report")

    def _set_context(self, options):
        ctx = super(AccountDisbursementJournalSummary, self)._set_context(options)
        ctx['journal_type'] = ['cash', 'bank']
        return ctx

    def _get_templates(self):
        templates = super(AccountDisbursementJournalSummary, self)._get_templates()
