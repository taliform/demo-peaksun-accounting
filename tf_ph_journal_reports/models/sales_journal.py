...
class AccountSalesJournalSummary(models.AbstractModel):
    _name = 'account.sales.journal.summary'
    _description = 'Sales Journal Summary'
    _inherit = 'account.partner.journal.summary'

    def _set_context(self, options):
        ctx = super(AccountSalesJournalSummary, self)._set_context(options)
    ...
    @api.model
    def get_title(self):
        return _('Sales Journal Report')

    def _get_report_name(self):
        return _("Sales Journal Report")

    def _get_templates(self):
        templates = super(AccountSalesJournalSummary, self)._get_templates()
