...
class TfCfDisbursement(models.TransientModel):
    _name = 'tf.cf.disbursement'
    _description = "Generate Disbursement Cash Flow"
    ...
    def action_generate(self):
        ...
        if not return_id:
            return {
                'name': "Disbursements: %s - %s" % (self.date_from, self.date_to),
