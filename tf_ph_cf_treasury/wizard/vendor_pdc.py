...
class TfCfVendorPdc(models.TransientModel):
    _name = 'tf.cf.vendor.pdc'
    _description = "Generate Vendor PDC Cash Flow"
    ...
    def action_generate(self):
        ...
        if not return_id:
            return {
                'name': "Vendor PDCs: %s - %s" % (self.date_from, self.date_to),
